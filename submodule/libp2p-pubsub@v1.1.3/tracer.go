...
const (
	...
	rejectNotWhitelistedPeer    = "not whitelisted peer"
	rejectNotWhitelistedSource  = "not whitelisted source"
	rejectNotBelongToThisPubsub = "not belong to this pubsub"
...
const RemoteTracerProtoID = protocol.ID("/libp2p/libp2ppubsub/tracer/1.0.0")
