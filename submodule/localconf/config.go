...
var (
	...
	// FindDeleteBlockChainNotifyC is the chan for finding delete block chain configs.
...
func UpdateLocalConfig(key string, value string) error {
	cmViper := viper.New()
	...
	cmViper.Set(key, temp)
	if err := cmViper.WriteConfig(); err != nil {
		return err
	}
	return nil
}
