...
require (
	...
	chainmaker.org/chainmaker/recorderfile v0.0.0
...
// replace some package for record
replace (
	chainmaker.org/chainmaker/consensus-maxbft/v2 => ./submodule/consensus-maxbft
	chainmaker.org/chainmaker/consensus-tbft/v2 => ./submodule/consensus-tbft-v2.4.2
	chainmaker.org/chainmaker/libp2p-pubsub => ./submodule/libp2p-pubsub@v1.1.3
	chainmaker.org/chainmaker/localconf/v2 v2.3.1 => ./submodule/localconf
	chainmaker.org/chainmaker/net-libp2p v1.2.2 => ./submodule/net-libp2p@v1.2.0
	chainmaker.org/chainmaker/net-liquid => ./submodule/net-liquid@v1.1.0
	chainmaker.org/chainmaker/protocol/v2 => ./submodule/protocol
	chainmaker.org/chainmaker/recorderfile => ./submodule/recorderfile
	chainmaker.org/chainmaker/store/v2 => ./submodule/store
	chainmaker.org/chainmaker/txpool-batch/v2 => ./submodule/txpool-batch
	chainmaker.org/chainmaker/txpool-normal/v2 => ./submodule/txpool-normal
	chainmaker.org/chainmaker/txpool-single/v2 => ./submodule/txpool-single
)
